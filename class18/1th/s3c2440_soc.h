...
#define     NFCCMD                    __REG_BYTE(0x4E000004)  //NAND flash command                   
#define     NFADDR                   __REG_BYTE(0x4E000008)  //NAND flash address                   
#define     NFDATA                   __REG_BYTE(0x4E00000C)  //NAND flash data                      
...
#define     NFSTAT                   __REG_BYTE(0x4E000010)  //NAND flash operation status          
